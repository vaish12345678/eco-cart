...
//             Shop Smart, Shop Green with <span className="text-green-500">EcoCart 🌿</span>
//           </h1>
//           <p className="text-lg md:text-xl text-gray-700 mb-8">
//             Discover your carbon impact, make eco-friendly choices, and drive sustainable change.
//           </p>
//           <Link
//             to="/products"
...
//           {/* Feature 1 */}
//           <div className="bg-green-100 p-6 rounded-xl shadow hover:shadow-md">
//             <h2 className="text-xl font-semibold text-green-800 mb-2">Eco Score</h2>
//             <p className="text-gray-600">
//               Get a sustainability score for every product you shop — know the impact before you buy.
//             </p>
//           </div>

//           {/* Feature 2 */}
//           <div className="bg-green-100 p-6 rounded-xl shadow hover:shadow-md">
//             <h2 className="text-xl font-semibold text-green-800 mb-2">Smart Suggestions</h2>
//             <p className="text-gray-600">
//               We recommend greener alternatives so you can shop better and reduce your footprint.
//             </p>
//           </div>

//           {/* Feature 3 */}
//           <div className="bg-green-100 p-6 rounded-xl shadow hover:shadow-md">
//             <h2 className="text-xl font-semibold text-green-800 mb-2">Carbon Calculator</h2>
//             <p className="text-gray-600">
//               Calculate your carbon emissions and track your impact in real-time.
//             </p>
//           </div>
//         </div>
//       </section>
...
//         &copy; 2025 EcoCart. Made with ❤️ for a greener world.
//       </footer>
//     </div>
//   );
// };
